...
- Positivity: <br> Prob of receiving every value of treatment (conditional on $L$) is $\geqslant 0$.
]]]
...
- We can also compute the associational risk ratio = 1 and interpret it as an causal risk ratio
]
