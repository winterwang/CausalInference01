...
### Population risk under treatment or not <br> by stratification
...
- If these two causal risk difference differ, we say that there is **additive effect modification** by $V$. 
...
--
.med[
- There is evidence that both additive and multiplicative effect modification by nationality $V$ of the effect of $A$ on $Y$.
